...
def kind_of_artifact(
    ...
    plt.tight_layout()
    plt.savefig(
        "analyzing/plots/finds_of_artifacts.png",
        dpi=300,
        bbox_inches="tight",
    )
    plt.show()
...
def create_conversion_table():
    ...
    dfi.export(
        styled_df_1,
        "analyzing/plots/table_output_1.png",
    )
    dfi.export(
        styled_df_2,
        "analyzing/plots/table_output_2.png",
    )
